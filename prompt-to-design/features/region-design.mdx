---
title: Region Redesign
---

import Image from '@/components/Image';

Region Redesign lets you update **one specific area** of a frame without affecting the rest of your layout.  
...
## 1. Select the **Region Redesign** tab

Open the **prompt.to.design** plugin and click the **Region Redesign** tab.  
