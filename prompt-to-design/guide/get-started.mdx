...
description: Learn how to install and start using Prompt.to.design in Figma.
---
...
- **Region Design:** Redesign selected areas while keeping overall style.  
- **Smart Fill:** Fill blank spaces with context-aware content.  
- **Modify Elements:** Edit text, color, and layout using natural language.
